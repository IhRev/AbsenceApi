...
namespace Absence.Infrastructure.Database.Migrations
{
    ...
    [Migration("20260126205345_AddCountsTowardAnnualLeave")]
    partial class AddCountsTowardAnnualLeave
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Absence.Domain.Entities.AbsenceEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Absence.Domain.Entities.AbsenceTypeEntity", b =>
                {
                    ...
                    b.Property<bool>("CountsTowardAnnualLeave")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Absence.Domain.Entities.HolidayEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Absence.Domain.Entities.OrganizationEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Absence.Domain.Entities.OrganizationUserEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Absence.Domain.Entities.OrganizationUserInvitationEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Absence.Domain.Entities.UserEntity", b =>
                {
            ...
            modelBuilder.Entity("Absence.Domain.Entities.AbsenceEntity", b =>
                {
                    b.HasOne("Absence.Domain.Entities.AbsenceTypeEntity", "AbsenceType")
                        .WithMany("Absences")
                    ...
                    b.HasOne("Absence.Domain.Entities.UserEntity", "User")
                        .WithMany("Absences")
            ...
            modelBuilder.Entity("Absence.Domain.Entities.OrganizationEntity", b =>
                {
                    b.HasOne("Absence.Domain.Entities.UserEntity", "Owner")
            ...
            modelBuilder.Entity("Absence.Domain.Entities.OrganizationUserInvitationEntity", b =>
                {
                    b.HasOne("Absence.Domain.Entities.UserEntity", "InvitedUser")
                    ...
                    b.HasOne("Absence.Domain.Entities.UserEntity", "InviterUser")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Absence.Domain.Entities.UserEntity", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Absence.Domain.Entities.OrganizationEntity", b =>
                {
                    ...
                    b.Navigation("OrganizationUserInvitations");
